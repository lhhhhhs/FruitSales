...
public class FruitDaoImpl implements FruitDao {
    ...
    public String addFruit(Fruit fruit) {
        ...
        JDBCUtils.update(sql, fruit.getName(),fruit.getPrice(),fruit.getCost(),fruit.getSales());
        return null;
    }
    ...
    public BigDecimal update(Fruit fruit) {
        ...
        JDBCUtils.update(sql, fruit.getName(),fruit.getPrice(),fruit.getCost(),fruit.getSales(),fruit.getId());
        return null;
    }
